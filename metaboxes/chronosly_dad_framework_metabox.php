...
if($st != "front"){
 ...
 <?php } ?>
    ...
    ?>
<div <?php if($stilo) echo "style='$stilo'";?> base="<?php echo $template;?>" class="chronosly perfil<?php echo $perfil;?> ch-<?php echo $template;?>  ch-<?php echo $st;?> ch-<?php echo $vista;?> ev-<?php echo $temp->post->ID; if(isset($_REQUEST['small']) and $_REQUEST["small"]) echo " small";?>">
<?php } else { ?>

<div <?php if($stilo) echo "style='$stilo;{{max-width}}{{min-width}}'";?> base="<?php echo $template;?>" class="chronosly perfil<?php echo $perfil;?> ch-<?php echo $template;?>  ch-<?php echo $st;?> ch-<?php echo $vista;?> ev-{{id}} {{size}}">
<?php
        } //skeleton for front dad templates
        if(isset($temp->boxes)){ //if box
            $exist_featured = 0;
